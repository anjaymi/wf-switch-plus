...
- 最新版本：`0.3.5`
- VSIX：[`releases/wf-switch-plus-0.3.5.vsix`](releases/wf-switch-plus-0.3.5.vsix)
...
```powershell
code --install-extension .\releases\wf-switch-plus-0.3.5.vsix
```
...
- 修复 Token 趋势卡右上角显示 `0%` 的问题。
- 趋势卡现在显示真实节省率 `省 X%`，实时刷新也保持一致。

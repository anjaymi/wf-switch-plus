...
- 最新版本：`0.3.3`
- VSIX：[`releases/wf-switch-plus-0.3.3.vsix`](releases/wf-switch-plus-0.3.3.vsix)
...
```powershell
code --install-extension .\releases\wf-switch-plus-0.3.3.vsix
```
